...
\autor{Bruno Lopes Alcantara Batista}
\titulo{Modelo Canônico de Trabalho Acadêmico \\ da Universidade de Fortaleza com \abnTeX}
\data{2018}
\local{Fortaleza -- Ceará}

% Exemplo: \dataaprovacao{01 de Janeiro de 2018}
\dataaprovacao{01 de Janeiro de 2019}
...
\begin{document}
	...
	\imprimiranexos
		...
		\input{elementos-pos-textuais/apendices/savefile.tex}
		\input{elementos-pos-textuais/apendices/model.tex}
		\input{elementos-pos-textuais/apendices/utils.tex}
		\input{elementos-pos-textuais/apendices/drive.tex}
	\imprimirindice
